            ...
            <div className="dropdown dropdown-end ">
              ...
              >
                <li>
                  <Link
                    to="/user-profile"
                    className="justify-between text-accent-content  hover:bg-[#b6dd40]"
                  >
                    Profile
                  </Link>
                </li>
                <li>
                  <Link to="/order-history" className="text-accent-content hover:bg-[#b6dd40]">
                    Order history
                  </Link>
                </li>
                <li>
                  <Link to="/login" className="text-accent-content hover:bg-[#b6dd40]">
                    Logout
                  </Link>
                </li>
              </ul>
